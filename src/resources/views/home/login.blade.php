                        ...
                        <div class="col-lg-6">
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="p-4 my-auto">
                                    <h4 class="fs-20">{{ __('auth.Sign In') }}</h4>
                                    <p class="text-muted mb-3">{{ __('auth.Enter your email address and password to access account.') }}
                                    </p>
                                    ...
                                    <form action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="mb-0 text-start">
                                            <button class="btn btn-soft-primary w-100" type="submit"><i
                                                    class="ri-login-circle-fill me-1"></i> <span class="fw-bold">{{ __('auth.Log In') }}</span> </button>
                                        </div>
